 /**
    ...
    /**
     * @brief Проверка на возможность Шаха для Игрока
     * 
     */
    ...
    /**
     * @brief Выполнение перемещение фигуры на доске, записывает ход в историю и, если пешка достигла конца доски, вызывает функцию для ее преобразования
     * 
     */
